...
int main(){
	...
	//construct a vector and list of same size using push_front
	...
	for( int i = 0 ; i < sz2; ++i )
    {
        doublevec2.push_front( (double)i );
    }
	finish = clock();
	...
	for( int i = 0 ; i < sz3; ++i )
    {
        doublevec3.push_front( (double)i );
    }
	finish = clock();
	...
	for( int i = 0 ; i < sz4; ++i )
    {
        doublevec4.push_front( (double)i );
    }
	finish = clock();
	...
	for( int i = 0 ; i < sz1; ++i )
    {
        doublelist.push_front( (double)i );
    }
	finish = clock();
	...
	for( int i = 0 ; i < sz2; ++i )
    {
        doublelist2.push_front( (double)i );
    }
	finish = clock();
	...
	for( int i = 0 ; i < sz3; ++i )
    {
        doublelist3.push_front( (double)i );
    }
	finish = clock();
	...
	for( int i = 0 ; i < sz4; ++i )
    {
        doublelist4.push_front( (double)i );
    }
	finish = clock();
